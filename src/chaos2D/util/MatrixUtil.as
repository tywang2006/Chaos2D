package chaos2D.util
{
    ...
    public class MatrixUtil
    {
		...
		public static function convertTo2D(matrix:Matrix3D, resultMatrix:Matrix=null):Matrix
		{
			...
			resultMatrix.a = matrix.rawData[0];
			resultMatrix.b = matrix.rawData[1];
			resultMatrix.c = matrix.rawData[4];
			resultMatrix.d = matrix.rawData[5];
			resultMatrix.tx = matrix.rawData[12];
			resultMatrix.ty = matrix.rawData[13];
